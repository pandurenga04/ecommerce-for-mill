...
import { Star, Phone, Mail, MapPin, Leaf, Award, Users, Clock, ShoppingBag, ArrowRight } from "lucide-react"
...
export default function HomePage() {
  ...
  if (showLoading) {
    return (
      <div className="min-h-screen gradient-green flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center animate-fade-in z-10">
          <div className="mb-8">
            <div className="w-24 h-24 mx-auto bg-white rounded-full flex items-center justify-center mb-6 animate-pulse-green">
              <Leaf className="w-12 h-12 text-green-600" />
            </div>
          </div>
          <h1 className="text-4xl md:text-7xl font-bold text-white mb-6 drop-shadow-lg">SRI SRINIVASA</h1>
          <h2 className="text-3xl md:text-5xl font-bold text-green-100 mb-4">FLOUR MILLS</h2>
          <p className="text-xl md:text-2xl text-green-100 font-semibold animate-float">80 YEARS OF LEGACY</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-6xl px-4">
          <div className="animate-slide-up">
            <h1 className="text-5xl md:text-8xl font-bold mb-8 drop-shadow-2xl leading-tight">
              Traditional
              <span className="block text-green-200">Quality</span>
            </h1>
            <p className="text-xl md:text-3xl mb-12 drop-shadow-lg font-light max-w-4xl mx-auto leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
              <Link href="/products">
                <Button
                  size="lg"
                  className="bg-white text-green-700 hover:bg-green-50 px-12 py-6 text-xl font-semibold shadow-2xl transform hover:scale-105 transition-all duration-300 rounded-full"
                >
                  Shop Now
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <Card
                key={index}
                className="text-center p-8 card-hover border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50"
              >
      ...
      {/* About Section */}
      <section className="py-24 gradient-green-light relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('/placeholder.svg?height=800&width=1200')] opacity-5"></div>
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gradient mb-6">About Sri Srinivasa Flour Mills</h2>
            <div className="w-32 h-1 gradient-green mx-auto mb-8 rounded-full"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <span className="text-gray-700 text-lg font-semibold">5.0 Customer Rating</span>
              </div>

              <Link href="/products">
                <Button className="gradient-green text-white px-8 py-4 text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300 rounded-full">
                  Explore Products
                  <ArrowRight className="ml-2 w-5 h-5" />
                </Button>
              </Link>
            ...
            <Card className="bg-white/80 backdrop-blur-sm shadow-2xl border-0 card-hover">
              <CardContent className="p-10">
                <h3 className="text-3xl font-bold text-gradient mb-8">Why Choose Us?</h3>
                <ul className="space-y-6">
                  {[
                    ...
                    <li key={index} className="flex items-start gap-4">
                      <div className="w-8 h-8 gradient-green rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-5xl font-bold text-gradient mb-6">Our Commitment</h2>
            <div className="w-32 h-1 gradient-green mx-auto rounded-full"></div>
          </div>
      ...
      <section className="py-24 gradient-green relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <h2 className="text-5xl font-bold text-white mb-8">Ready to Experience Quality?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-300 ml-2">Trusted by 5000+ families</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-300">+91 79043 56029</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center">
                    <Mail className="w-5 h-5 text-white" />
                  </div>
                  <span className="text-gray-300">info@srisrinivasaflour.com</span>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 bg-green-600 rounded-full flex items-center justify-center mt-1">
